...
CREATE TABLE `order_details` (
  ...
  CONSTRAINT `order_details_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `sampledb`.`order_info` (`order_id`),
  CONSTRAINT `order_details_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `sampledb`.`product_info` (`product_id`)
...
CREATE TABLE `return_info` (
  ...
  KEY `order_id` (`order_id`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `return_info_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `sampledb`.`order_info` (`order_id`),
  CONSTRAINT `return_info_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `sampledb`.`product_info` (`product_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-30 12:54:20
